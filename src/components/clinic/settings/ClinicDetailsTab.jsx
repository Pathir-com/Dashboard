...
import { Link2, CheckCircle2, Phone, Mail } from 'lucide-react';
import { toast } from 'sonner';
import HolidayHours from './HolidayHours';

const DAYS = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];

export default function ClinicDetailsTab({ details, setDetails, hours, setHours, holidayHours, setHolidayHours, integrations, pearDental, setPearDental, practiceType, setPracticeType }) {
